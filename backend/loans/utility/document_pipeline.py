...
def _validate_by_document_type(doc_type_upper, extracted, db_pan, db_aadhaar, declared_org,
                                declared_income, declared_years, clean_raw_text, anomalies):
...
def process_loan_document(image_file, user, declared_org="", declared_income="", declared_years="", expected_doc_type="Unknown"):
    ...
    _validate_by_document_type(
        doc_type_upper, extracted, db_pan, db_aadhaar,
        declared_org, declared_income, declared_years,
        clean_raw_text, anomalies
    )
